...
def cryptopals_encrypt(key_in_bytes, plain_in_bytes):
...
def cryptopals_decrypt(key_in_bytes, cipher_in_base64):
    keys = cryptopals_key_expansion_int(key_in_bytes)
    ...
    # sys.stdout.buffer.write(return_in_aggregate)
    return return_in_aggregate


def main():

    # Base 64 encrypted comes in a text file
    based = import_text('break_repeating_key_xor.txt')

    # Password comes in byte string formta
    password = b'YELLOW SUBMARINE'
    cryptopals_decrypt(password, based)
